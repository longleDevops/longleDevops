- 👋 Hi, my name is Long who love working on full-stack web or mobile application ranging from designing the user interface to implementing backend logic of an application.
